...
from smaragdine.hook import SmaragdineHook
...
if __name__ == '__main__':
    ...
    smaragdine_hook = SmaragdineHook(period_ms=4, output_dir='/tmp/smaragdine')
    hooks = [
        smaragdine_hook,
        tf.estimator.ProfilerHook(save_steps=1, output_dir='/tmp/smaragdine'),
    ]
